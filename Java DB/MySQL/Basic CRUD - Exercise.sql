...
CREATE DATABASE IF NOT EXISTS `soft_uni_db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `soft_uni_db`;
...
-- 23.  Countries and Currency (Euro / Not Euro) /* can be done with if or elt */
SELECT `country_name`, `country_code`, 
CASE WHEN 
`currency_code` = 'EUR' THEN 'Euro'
ELSE 'Not Euro'
END AS 'currency'
FROM `countries`
